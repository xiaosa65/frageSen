...
<head>
    ...
    <!-- Morris -->
    <link href="public/orgin/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">
...
<body class="gray-bg sidebar-content">
        ...
        <div>
            ...
            <div class="feed-element">
                <a href="index_3.html#" class="pull-left">
                    <img alt="image" class="img-circle" src="public/orgin/img/a1.jpg">
                </a>
            ...
            <div class="feed-element">
                <a href="index_3.html#" class="pull-left">
                    <img alt="image" class="img-circle" src="public/orgin/img/a2.jpg">
                </a>
                <div class="media-body">
                    V信已经提前恢复，也算是个好消息吧
                    <br>
            ...
            <div class="feed-element">
                <a href="index_3.html#" class="pull-left">
                    <img alt="image" class="img-circle" src="public/orgin/img/a3.jpg">
                </a>
                <div class="media-body">
                    是你对不对
                    <br>
    ...
    <script src="public/orgin/js/plugins/flot/jquery.flot.js"></script>
    <script src="public/orgin/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="public/orgin/js/plugins/flot/jquery.flot.spline.js"></script>
    <script src="public/orgin/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="public/orgin/js/plugins/flot/jquery.flot.pie.js"></script>
    <script src="public/orgin/js/plugins/flot/jquery.flot.symbol.js"></script>
    <script src="public/orgin/js/plugins/flot/curvedLines.js"></script>
    <script src="public/orgin/js/plugins/peity/jquery.peity.min.js"></script>
    <script src="public/orgin/js/demo/peity-demo.min.js"></script>
    <script src="public/orgin/js/content.min.js?v=1.0.0"></script>
    <script src="public/orgin/js/plugins/jquery-ui/jquery-ui.min.js"></script>
    <script src="public/orgin/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="public/orgin/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
    <script src="public/orgin/js/plugins/easypiechart/jquery.easypiechart.js"></script>
    <script src="public/orgin/js/plugins/sparkline/jquery.sparkline.min.js"></script>
    <script src="public/orgin/js/demo/sparkline-demo.min.js"></script>
    <script>
