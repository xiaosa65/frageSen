...
<body class="gray-bg">
    <div class="row  border-bottom white-bg dashboard-header">
        ...
        <div class="col-sm-3">
            ...
            <br>
            <br>
            <img src="public/orgin/img/qr_code.png" width="100%" style="max-width:264px;">
            <br>
        </div>
        <div class="col-sm-5">
            <h2>
    ...
    <script src="public/orgin/js/content.min.js"></script>
    <script src="public/orgin/js/welcome.min.js"></script>
</body>
