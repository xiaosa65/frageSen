...
<head>
    ...
    <link rel="shortcut icon" href="favicon.ico"> <link href="public/rogin/css/bootstrap.min.css?v=3.3.5" rel="stylesheet">
    <link href="public/rogin/css/font-awesome.min.css?v=4.4.0" rel="stylesheet">

    <link href="public/rogin/css/animate.min.css" rel="stylesheet">
    <link href="public/rogin/css/style.min.css?v=4.0.0" rel="stylesheet"><base target="_blank">
...
<body class="gray-bg">
    ...
    <script src="public/orgin/js/plugins/echarts/echarts-all.js"></script>
    <script src="public/orgin/js/content.min.js?v=1.0.0"></script>
    <script src="public/orgin/js/demo/echarts-demo.min.js"></script>
