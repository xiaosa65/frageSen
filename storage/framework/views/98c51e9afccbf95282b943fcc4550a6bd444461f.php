...
<body>
    <div class="addType">
        ...
        <ul>
            ...
            <li><input type="hidden" name="username" value="<?php echo e(Session::get('username')); ?>" />
    ...
    <div class="typeShow">
        ...
        <ul class="frageS1">
            <?php $__currentLoopData = $dataAll; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="frageS1-li">
                <span><img src="public/admin/img/frageType1-2.png" alt="<?php echo e($val['unGrade']); ?>" /><?php echo e($val['unGrade']); ?></span>
                <ul class="frageS2">
                    <?php $__currentLoopData = $val['unid']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ke=>$va): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li><span><img src="public/admin/img/frageType2-2.png" alt="<?php echo e($val['unGrade']); ?>" /><?php echo e($va['unGrade']); ?></span>
                        <ul class="frageS3">
                            <?php $__currentLoopData = $va['unid']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li><span><img src="public/admin/img/frageType3-2.png" alt="<?php echo e($val['unGrade']); ?>" /><?php echo e($v['unGrade']); ?></span></li>
