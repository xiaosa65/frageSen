...
<head>
    ...
    <title>H+ 后台主题UI框架 - Morris.js图表</title>
...
<body class="gray-bg">
    ...
    <script src="public/orgin/js/plugins/morris/raphael-2.1.0.min.js"></script>
    <script src="public/orgin/js/plugins/morris/morris.js"></script>
    <script src="public/orgin/js/content.min.js?v=1.0.0"></script>
    <script src="public/orgin/js/demo/morris-demo.min.js"></script>
