...
<body class="gray-bg">
                        ...
                        <div class="m-t m-b">
                            ...
                            <div id="userAlbums" style="display:none">
                                <a href="img/a1.jpg" class="fancybox" title="选取该照片">
                                    <img src="public/orgin/img/a1.jpg" alt="示例图片1" />
                                </a>
                                <a href="img/a2.jpg" class="fancybox" title="选取该照片">
                                    <img src="public/orgin/img/a2.jpg" alt="示例图片2" />
                                </a>
                                <a href="img/a3.jpg" class="fancybox" title="选取该照片">
                                    <img src="public/orgin/img/a3.jpg" alt="示例图片2" />
                                </a>
                                <a href="img/a4.jpg" class="fancybox" title="选取该照片">
                                    <img src="public/orgin/img/a4.jpg" alt="示例图片2" />
                                </a>
                                <a href="img/a5.jpg" class="fancybox" title="选取该照片">
                                    <img src="public/orgin/img/a5.jpg" alt="示例图片2" />
                                </a>
                                <a href="img/a6.jpg" class="fancybox" title="选取该照片">
                                    <img src="public/orgin/img/a6.jpg" alt="示例图片2" />
                                </a>
                                <a href="img/a7.jpg" class="fancybox" title="选取该照片">
                                    <img src="public/orgin/img/a7.jpg" alt="示例图片2" />
                                </a>
                                <a href="img/a8.jpg" class="fancybox" title="选取该照片">
                                    <img src="public/orgin/img/a8.jpg" alt="示例图片2" />
                                </a>
                                <a href="img/a9.jpg" class="fancybox" title="选取该照片">
                                    <img src="public/orgin/img/a9.jpg" alt="示例图片2" />
                                </a>>
                            </div>
                        </div>
    ...
    <script type="text/javascript" src="public/orgin/plugins/fullavatareditor/scripts/swfobject.js"></script>
    <script type="text/javascript" src="public/orgin/plugins/fullavatareditor/scripts/fullAvatarEditor.js"></script>
    <script type="text/javascript" src="public/orgin/plugins/fullavatareditor/scripts/jQuery.Cookie.js"></script>
    <script type="text/javascript" src="public/orgin/plugins/fullavatareditor/scripts/test.js"></script>
