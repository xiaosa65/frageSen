...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="public/orgin/css/plugins/simditor/simditor.css" />
...
<body class="gray-bg">
    ...
    <script type="text/javascript" src="public/orgin/js/plugins/simditor/module.js"></script>
    <script type="text/javascript" src="public/orgin/js/plugins/simditor/uploader.js"></script>
    <script type="text/javascript" src="public/orgin/js/plugins/simditor/hotkeys.js"></script>
    <script type="text/javascript" src="public/orgin/js/plugins/simditor/simditor.js"></script>
    <script>
