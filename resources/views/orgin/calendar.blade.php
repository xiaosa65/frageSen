...
<head>
    ...
    <link href="public/orgin/css/plugins/fullcalendar/fullcalendar.css" rel="stylesheet">
    <link href="public/orgin/css/plugins/fullcalendar/fullcalendar.print.css" rel="stylesheet">
...
<body class="gray-bg">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            ...
                            <a class="dropdown-toggle" data-toggle="dropdown" href="public/orgin/calendar.html#">
                                <i class="fa fa-wrench"></i>
                            </a>
                            <ul class="dropdown-menu dropdown-user">
                                <li><a href="public/orgin/calendar.html#">选项1</a>
                                </li>
                                <li><a href="public/orgin/calendar.html#">选项2</a>
                                </li>
                            </ul>
                            <a class="close-link">
    ...
    <script src="public/orgin/js/jquery-ui.custom.min.js"></script>
    <script src="public/orgin/js/plugins/iCheck/icheck.min.js"></script>
    <script src="public/orgin/js/plugins/fullcalendar/fullcalendar.min.js"></script>
    <script>
