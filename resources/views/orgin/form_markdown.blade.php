...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="public/orgin/css/plugins/markdown/bootstrap-markdown.min.css" />
...
<body class="gray-bg">
    ...
    <script type="text/javascript" src="public/orgin/js/plugins/markdown/markdown.js"></script>
    <script type="text/javascript" src="public/orgin/js/plugins/markdown/to-markdown.js"></script>
    <script type="text/javascript" src="public/orgin/js/plugins/markdown/bootstrap-markdown.js"></script>
    <script type="text/javascript" src="public/orgin/js/plugins/markdown/bootstrap-markdown.zh.js"></script>
