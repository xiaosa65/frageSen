...
<head>
    ...
    <link href="public/orgin/css/plugins/iCheck/custom.css" rel="stylesheet">
    <link href="public/orgin/css/plugins/chosen/chosen.css" rel="stylesheet">
    <link href="public/orgin/css/plugins/colorpicker/css/bootstrap-colorpicker.min.css" rel="stylesheet">
    <link href="public/orgin/css/plugins/cropper/cropper.min.css" rel="stylesheet">
    <link href="public/orgin/css/plugins/switchery/switchery.css" rel="stylesheet">
    <link href="public/orgin/css/plugins/jasny/jasny-bootstrap.min.css" rel="stylesheet">
    <link href="public/orgin/css/plugins/nouslider/jquery.nouislider.css" rel="stylesheet">
    <link href="public/orgin/css/plugins/datapicker/datepicker3.css" rel="stylesheet">
    <link href="public/orgin/css/plugins/ionRangeSlider/ion.rangeSlider.css" rel="stylesheet">
    <link href="public/orgin/css/plugins/ionRangeSlider/ion.rangeSlider.skinFlat.css" rel="stylesheet">
    <link href="public/orgin/css/plugins/awesome-bootstrap-checkbox/awesome-bootstrap-checkbox.css" rel="stylesheet">
    <link href="public/orgin/css/plugins/clockpicker/clockpicker.css" rel="stylesheet">
...
<body class="gray-bg">
                        ...
                        <div class="switch">
                            <div class="onoffswitch">
                                ...
                                <label class="onoffswitch-label" for="example1">
                                    ...
                                    <span class="onoffswitch-switch">2</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="image-crop">
                                    <img src="public/orgin/img/a3.jpg">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <h4>图片预览：</h4>
    ...
    <script src="public/orgin/js/plugins/chosen/chosen.jquery.js"></script>
    <script src="public/orgin/js/plugins/jsKnob/jquery.knob.js"></script>
    <script src="public/orgin/js/plugins/jasny/jasny-bootstrap.min.js"></script>
    <script src="public/orgin/js/plugins/datapicker/bootstrap-datepicker.js"></script>
    <script src="public/orgin/js/plugins/prettyfile/bootstrap-prettyfile.js"></script>
    <script src="public/orgin/js/plugins/nouslider/jquery.nouislider.min.js"></script>
    <script src="public/orgin/js/plugins/switchery/switchery.js"></script>
    <script src="public/orgin/js/plugins/ionRangeSlider/ion.rangeSlider.min.js"></script>
    <script src="public/orgin/js/plugins/iCheck/icheck.min.js"></script>
    <script src="public/orgin/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="public/orgin/js/plugins/colorpicker/bootstrap-colorpicker.min.js"></script>
    <script src="public/orgin/js/plugins/clockpicker/clockpicker.js"></script>
    <script src="public/orgin/js/plugins/cropper/cropper.min.js"></script>
    <script src="public/orgin/js/demo/form-advanced-demo.min.js"></script>
