        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <div class="social-feed-box">
                    ...
                    <div class="social-avatar">
                        <a href="" class="pull-left">
                            <img alt="image" src="public/orgin/img/a1.jpg">
                        </a>
                    ...
                    <div class="social-footer">
                        ...
                        <div class="social-comment">
                            <a href="" class="pull-left">
                                <img alt="image" src="public/orgin/img/a2.jpg">
                            </a>
                            <div class="media-body">
                                <a href="#">
                                            尤小右
                        ...
                        <div class="social-comment">
                            <a href="" class="pull-left">
                                <img alt="image" src="public/orgin/img/a3.jpg">
                            </a>
                            <div class="media-body">
                ...
                <div class="social-feed-box">
                    ...
                    <div class="social-avatar">
                        <a href="" class="pull-left">
                            <img alt="image" src="public/orgin/img/a6.jpg">
                        </a>
                        <div class="media-body">
                            <a href="#">
                                        尤小右
                    ...
                    <div class="social-body">
                        ...
                        <img src="public/orgin/img/p1.jpg" class="img-responsive">
                        <div class="btn-group">
                            <button class="btn btn-white btn-xs"><i class="fa fa-thumbs-up"></i> 赞</button>
                            <button class="btn btn-white btn-xs"><i class="fa fa-comments"></i> 评论</button>
                            <button class="btn btn-white btn-xs"><i class="fa fa-share"></i> 分享</button>
                    ...
                    <div class="social-footer">
                        ...
                        <div class="social-comment">
                            <a href="" class="pull-left">
                                <img alt="image" src="public/orgin/img/a8.jpg">
                            </a>
                            <div class="media-body">
                                <a href="#">
                                            尤小右
                ...
                <div class="social-feed-box">
                    ...
                    <div class="social-avatar">
                        <a href="" class="pull-left">
                            <img alt="image" src="public/orgin/img/a4.jpg">
                        </a>
                        <div class="media-body">
                            <a href="#">
                                        尤小右
            ...
            <div class="col-sm-6">
                ...
                <div class="social-feed-separated">
                    ...
                    <div class="social-avatar">
                        <a href="">
                            <img alt="image" src="public/orgin/img/a5.jpg">
                        </a>
                    </div>
                    ...
                    <div class="social-feed-box">
                        ...
                        <div class="social-body">
                            ...
                            <img src="public/orgin/img/p2.jpg" class="img-responsive">
                            <div class="btn-group">
                                <button class="btn btn-white btn-xs"><i class="fa fa-thumbs-up"></i> 赞</button>
                                <button class="btn btn-white btn-xs"><i class="fa fa-comments"></i> 评论</button>
                                <button class="btn btn-white btn-xs"><i class="fa fa-share"></i> 分享</button>
                        ...
                        <div class="social-footer">
                            ...
                            <div class="social-comment">
                                ...
                                <div class="social-comment">
                                    <a href="" class="pull-left">
                                        <img alt="image" src="public/orgin/img/a7.jpg">
                                    </a>
                                    <div class="media-body">
                                        <a href="#">
                                                    尤小右
