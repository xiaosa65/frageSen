...
<head>
    ...
    <link href="public/orgin/css/plugins/bootstrap-table/bootstrap-table.min.css" rel="stylesheet">
...
<body class="gray-bg">
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5>Bootstrap table <a href="http://bootstrap-table.wenzhixin.net.cn/zh-cn/">http://bootstrap-table.wenzhixin.net.cn/zh-cn/</a></h5>
    ...
    <script src="public/orgin/js/plugins/bootstrap-table/bootstrap-table.min.js"></script>
    <script src="public/orgin/js/plugins/bootstrap-table/bootstrap-table-mobile.min.js"></script>
    <script src="public/orgin/js/plugins/bootstrap-table/locale/bootstrap-table-zh-CN.min.js"></script>
    <script src="public/orgin/js/demo/bootstrap-table-demo.min.js"></script>
