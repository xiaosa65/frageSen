...
<head>
  ...
  <link rel="stylesheet" href="public/countDown/css/reset.css">

    <link rel="stylesheet" href="public/countDown/css/style.css" media="screen" type="text/css" />
...
<body> 
  ...
  <defs>
    ...
    <pattern id='image' width="1" height="1" viewBox="0 0 100 100" preserveAspectRatio="none">
      <image xlink:href="public/countDown/pattern_141.gif" width="100" height="100" preserveAspectRatio="none"></image>
    </pattern>
...
<script src="public/countDown/gg_bd_ad_720x90.js" type="text/javascript"></script>
<script src="public/countDown/follow.js" type="text/javascript"></script>
</div>
...
<section class="scene3d">
    ...
    <!-- 倒计时开始 --> 
    <div id="CountMsg" class="HotDate" style="color:red;font-size:50px;text-align: center;margin-top: 20px;"><span id="t_d">00天</span><span id="t_h">00小时</span><span id="t_m">00分钟</span><span id="t_s">00秒</span><br/>开启^_^</div>  
    <!-- 倒计时结束 -->
...
<script type="text/javascript"> 
  function getRTime(){ 
    var EndTime= new Date('2018/02/12 00:00:00'); //倒计时截止时间 
    ...
    if ( t > 0 ) { 
      ...
      window.location.href='http://120.92.82.182:444/login'
    }
  } 
  setInterval(getRTime,1000); //倒计时一秒一刷新
  </script>
  <!-- JS倒计时结束 -->
